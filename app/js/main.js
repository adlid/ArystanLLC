...
window.onscroll = function showHeader() {
  var header = document.querySelector('.top-line__top');
...
new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.deal-slider', {
  speed: 400,
  spaceBetween: 20,
  slidesPerView: 3,
  breakpoints: {
...
aos__WEBPACK_IMPORTED_MODULE_3___default().init(); // AOS.init({
//   // Global settings:
...
/* harmony import */ var _vendor_hystmodal_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/hystmodal.min */ "./src/js/vendor/hystmodal.min.js");
/* harmony import */ var _vendor_hystmodal_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_hystmodal_min__WEBPACK_IMPORTED_MODULE_1__);
...
var langArr = {
  ...
  "feedback-modal__title": {
    ...
    "en": "Do you have any additional questions?"
  },
  ...
  "service-marketing": {
    "ru": "Маркетинг ( продвижение в соцсетях)",
    "en": "Marketing (promotion in social networks)"
  },
  "service-accounting": {
  ...
  "service-handshake": {
    "ru": "Разработка бизнес-планов и фин моделей для инвестиционных и бизнес-проектов",
    "en": "Development of business plans and financial models for investment and business projects"
  },
  "service-branding": {
    "ru": "Брендинг для малого бизнеса ( логотип, фирменный стиль, айдентика)",
    "en": "Branding for small businesses (logo, corporate identity, identity)"
  },
  "service-video": {
    "ru": "Video production (Съемка рекламного видеоролика)",
    "en": "Video production (Shooting a promotional video) "
  },
  "number-title": {
    "ru": " Более 1 года",
    "en": "More than 1 year"
  ...
  "number-text-1": {
    "ru": "Гарантия на уникальность",
    "en": "Guarantee of uniqueness"
  },
  "number-text-2": {
    "ru": " Успешных консультаций",
    "en": "Successful consultations"
  },
  "number-text-3": {
    "ru": "Член команды",
    "en": "Team Member"
...
var allLang = ['en', 'ru'];
var rr = document.querySelector('.change-r');
...
function change() {
  ...
  var lang = rr.getAttribute('data-lang');
...
function changeLanguage() {
  ...
  for (var key in langArr) {
    ...
    var imput = document.getElementsByName('lng-' + key);
    ...
    if (imput.length > 0) {
      imput[0].placeholder = langArr[key][hash];
    }
  }
}
...
/***/ "./src/js/vendor/hystmodal.min.js":
/*!****************************************!*\
  !*** ./src/js/vendor/hystmodal.min.js ***!
  \****************************************/
/***/ (() => {
...
/* harmony import */ var _components_lang__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/lang */ "./src/js/components/lang.js");
/* harmony import */ var _components_lang__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_lang__WEBPACK_IMPORTED_MODULE_2__);
