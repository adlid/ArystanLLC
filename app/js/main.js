...
aos__WEBPACK_IMPORTED_MODULE_2___default().init((_AOS$init = {
  // Global settings:
  disable: false,
  ...
  dataAosId: ""
}, _defineProperty(_AOS$init, "animatedClassName", "work-items"), _defineProperty(_AOS$init, "offset", 120), _defineProperty(_AOS$init, "delay", 0), _defineProperty(_AOS$init, "duration", 400), _defineProperty(_AOS$init, "easing", 'ease'), _defineProperty(_AOS$init, "once", false), _defineProperty(_AOS$init, "mirror", false), _defineProperty(_AOS$init, "anchorPlacement", 'top-bottom'), _AOS$init)); // Подключение параллакса блоков при скролле


var rellax = new (rellax__WEBPACK_IMPORTED_MODULE_3___default())('.', {
  speed: -2,
  center: true,
  round: true
