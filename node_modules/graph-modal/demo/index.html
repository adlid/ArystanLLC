...
<head>
  ...
  <link rel="stylesheet" href="../dist/graph-modal.min.css">
  <style>
    .custom.animate-open {
      opacity: 1;
...
<body>
  <div class="content">
    <button class="btn-reset modal-btn modal-1" data-graph-path="first" data-graph-animation="fadeInUp"
      data-graph-speed="500">Открыть окно 1</button>
    <button class="btn-reset modal-btn modal-2" data-graph-path="second" data-graph-animation="custom">Открыть
      окно 2</button>
    <button class="btn-reset modal-btn modal-2" data-graph-path="second">Открыть окно 3</button>
  </div>
  <div class="graph-modal">
    ...
    <div class="graph-modal__container" role="dialog" aria-modal="true" data-graph-target="second">
      ...
      <button class="btn-reset modal-btn modal-3" data-graph-path="third">Открыть окно</button>
    </div>
  </div>
  <script src="../dist/graph-modal.min.js"></script>
  <script>
